...
class TimeFreqSeparableConv(nn.Module):
    def __init__(self,
        ...
        self.time_dw_conv = ConvBlock(in_channels=self.half_channels, out_channels=self.half_channels,
                                      kernel_size=(1, 3),
        ...
        self.freq_pw_conv = ConvBlock(in_channels=self.half_channels, out_channels=self.half_channels, kernel_size=1,
                                      use_bn=True, use_relu=True)
        self.time_pw_conv = ConvBlock(in_channels=self.half_channels, out_channels=self.half_channels, kernel_size=1,
                                      use_bn=True, use_relu=True)
